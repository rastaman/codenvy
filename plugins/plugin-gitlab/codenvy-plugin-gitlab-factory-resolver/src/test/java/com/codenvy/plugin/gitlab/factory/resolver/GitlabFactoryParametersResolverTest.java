...
public class GitlabFactoryParametersResolverTest {
  ...
  @Spy private GitlabURLParserImpl gitlabUrlParser = new GitlabURLParserImpl();
  ...
  @Captor private ArgumentCaptor<String> createFactoryParamsArgumentCaptor;

  /** Instance of resolver that will be tested. */
  @InjectMocks private GitlabFactoryParametersResolver gitlabFactoryParametersResolver;
  ...
  public void checkValidAcceptUrl() throws BadRequestException {
    Map<String, String> parameters =
        singletonMap(URL_PARAMETER_NAME, "https://gitlab.com/codenvy/codenvy.git");
    boolean accept = gitlabFactoryParametersResolver.accept(parameters);
    // shouldn't be accepted
    assertTrue(accept);
  }
