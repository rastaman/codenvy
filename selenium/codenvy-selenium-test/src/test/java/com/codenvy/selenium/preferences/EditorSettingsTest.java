...
public class EditorSettingsTest {
    ...
    @Inject
    private TestProfileServiceClient testProfileServiceClient;

    private static final String   PROJECT_NAME    = NameGenerator.generate("Prj", 6);
    private static final String   PATH_FOR_EXPAND = PROJECT_NAME + "/src/main/java/org.eclipse.che.examples";
    private static final String[] HEADER_SETTINGS = {"Tabs", "Language tools", "Typing", "White spaces", "Rulers"};
    private static final String   PATH            = PROJECT_NAME + "/src/main/java/org/eclipse/che/examples/GreetingController.java";
    ...
    public void editorSettingsTest() throws Exception {
        ...
        List<String> expectedEditorSettingsList = Files.readAllLines(Paths.get(resource.toURI()), Charset.forName("UTF-8"));
        ...
        projectExplorer.expandPathInProjectExplorerAndOpenFile(PATH_FOR_EXPAND, "GreetingController.java");
        ...
        Assert.assertEquals(settingsList, expectedEditorSettingsList, "Check settings list from the editor settings section:");
        enterTestCode(Preferences.FlagForEditorWidget.CHECK, settingsList);
        Assert.assertEquals(editor.getVisibleTextFromEditor(), EXPECTED_TEXT_WITH_CHECKING_SETTINGS,
        ...
        Assert.assertEquals(editor.getVisibleTextFromEditor(), EXPECTED_TEXT_WITH_UNCHECKING_SETTINGS,
