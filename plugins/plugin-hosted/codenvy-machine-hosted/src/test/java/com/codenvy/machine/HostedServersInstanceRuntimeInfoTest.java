...
public class HostedServersInstanceRuntimeInfoTest {
  ...
  @Mock private ServerEvaluationStrategyProvider serverEvaluationStrategyProvider;
  @Mock private ServerEvaluationStrategy serverEvaluationStrategy;

  @Test
  public void shouldReturnUnchangedServersOfDockerInstanceRuntimeInfoIfNoModifiersIsProvided()
      throws Exception {
    ...
    HostedServersInstanceRuntimeInfo runtimeInfo =
        prepareHostedServersInstanceRuntimeInfo(
            originServers,
            singletonMap(
                "otherreference",
                new UriTemplateServerProxyTransformer("http://host:9090/path", null, null) {}));
  ...
  public void shouldModifyOnlyServersThatHasCorrespondingModifier() throws Exception {
    ...
    expectedServers.put(
        ...
        new ServerImpl(
            ...
            "host:9090",
            "http://host:9090/path",
            new ServerPropertiesImpl("/path", "host:9090", "http://host:9090/path")));
  ...
  private HostedServersInstanceRuntimeInfo prepareHostedServersInstanceRuntimeInfo(
    ...
    HostedServersInstanceRuntimeInfo runtimeInfo =
        spy(
            new HostedServersInstanceRuntimeInfo(
    ...
    when(serverEvaluationStrategy.getServers(any(ContainerInfo.class), anyString(), any()))
        .thenReturn(servers);
