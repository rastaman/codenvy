...
public class OrganizationListPage {
    ...
    public enum OrganizationListHeader {
        NAME("NAME", 1), MEMBERS("MEMBERS", 2), TOTAL_RAM("TOTAL RAM", 3), AVAILABLE_RAM("AVAILABLE RAM", 4),
        SUB_ORGANIZATIONS("SUB-ORGANIZATIONS", 5), ACTIONS("ACTIONS", 6);
    ...
    private interface Locators {
        ...
        String ADD_SUB_ORGANIZATION_BUTTON_XPATH = "//che-button-primary//span[text()='Add Sub-Organization']";
        ...
        String ORGANIZATION_HEADER_XPATH         = "//list-organizations//div[contains(@class, 'che-list-header-column')]//span";
        String ORGANIZATION_SEARCH_XPATH         = "//list-organizations//div[contains(@class, 'header-search-input')]/input";
        ...
        String ORGANIZATION_EMPTY_LIST_XPATH     = "//div[@class='che-list-empty']/span[text()='There are no organizations.']";
        String SUB_ORGANIZATION_EMPTY_LIST_XPATH = "//div[@class='che-list-empty']/span[text()='There are no sub-organizations.']";
        String ORGANIZATION_CHECKBOX_XPATH       = "//organizations-item[%s]//md-checkbox/div[contains(@class, 'md-container')]";
    ...
    public boolean isAddOrganizationButtonVisible() {
        List<WebElement> elements = seleniumWebDriver.findElements(By.xpath(Locators.ADD_ORGANIZATION_BUTTON_XPATH));
    ...
    public boolean isAddSubOrganizationButtonVisible() {
        List<WebElement> elements = seleniumWebDriver.findElements(By.xpath(Locators.ADD_SUB_ORGANIZATION_BUTTON_XPATH));
        return elements.isEmpty() ? false : elements.get(0).isDisplayed();
    }
    ...
    public ArrayList<String> getOrganizationListHeaders() {
        List<WebElement> headers = seleniumWebDriver.findElements(By.xpath(Locators.ORGANIZATION_HEADER_XPATH));
    ...
    public int getOrganizationIndex(String name) {
        List<WebElement> cells = seleniumWebDriver.findElements(By.xpath(Locators.ORGANIZATION_NAME_XPATH));
        ArrayList<String> values = new ArrayList<>();
        cells.forEach(cell -> {
            values.add(cell.getText());
        });
