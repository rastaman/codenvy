...
public class CheckWorkWithVSTSProviderTest {
    private static final String GIT_URL_TO_PROJECT = "https://iedexmain1.visualstudio.com/_git/MyFirstProject";
    ...
    @Inject
    private ImportProjectFromLocation    importWidget;
    @Inject
    private Menu                         menu;
    @Inject
    ...
    @Inject
    private AskDialog                    authorizationDialog;
    @Inject
    private LoginVSTS                    loginVSTS;
    @Inject
    ...
    @Inject
    private OnpremTestOAuthServiceClient oAuthApiUtils;
    @Inject
    @Named("vsts.user")
    ...
    /**
     * auxulary method for defining the Microsoft login page (the page may have login and password fields on single page, sometimes password
     * field on one page, login field on other page)
     *
     * @return true if we on the page with login and password page and false if we on page with only password field
     */
