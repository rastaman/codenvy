...
public class CreateAccountAndResetPasswordOnOnpremTest {
    ...
    /**
     * Represents regexp patterns for matching defined link (for example:
     * confirmation for workspace creation, reset password, add member into organizations and etc.)
     */
    private static final String CONFIRM_WORKSPACE_CREATION_PATTERN = "(http|https)://%s/.*bearertoken=\\w*\\&?";
     ...
     * CODENVY_MAIL_SMTP_AUTH_USERNAME=
     * CODENVY_MAIL_SMTP_AUTH_PASSWORD=
     */
    @Test
    public void createAccountTest() throws Exception {
        ...
        ide.driver().get(mailReceiverUtils.waitAndGetLink(ELEMENT_TIMEOUT_SEC, EXPECTED_MESS_IN_CONSOLE_SEC, expectedMessageInMail,
