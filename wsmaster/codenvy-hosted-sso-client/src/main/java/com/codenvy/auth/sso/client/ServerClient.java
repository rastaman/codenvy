...
public interface ServerClient {
   ...
   * @param clientUrl - url of client who asking the principal.
   * @return - principal with roles. If token is not valid return null. @Deprecated use
   *     ServerClient.getUser(String token, String clientUrl)
   */
