...
public class LoginAndCreateOnpremAccountPage {
    ...
    @Inject
    public LoginAndCreateOnpremAccountPage(SeleniumWebDriver seleniumWebDriver, Loader loader, TestDashboardUrlProvider dashboardUrlProvider) {
    ...
    public void waitMainElementsOnLoginPage() {
        loadPageTimeout.until(ExpectedConditions.visibilityOfAllElements(Arrays.asList(usernameInput, passwordInput)));
    }
    ...
    public void waitLoginPageClosed() {
        loadPageTimeout.until(ExpectedConditions.invisibilityOfElementLocated(By.id(Locators.USER_NAME_INPUT_XPATH)));
        redrawTimeout.until(ExpectedConditions.invisibilityOfElementLocated(By.xpath(Locators.PASSWORD_INPUT_XPATH)));
    }

    /**
     * login on specified workspace
     * from login page
     *
     * @param userName
     * @param password
    ...
    public void clickCreateNewAccount() {
        loadPageTimeout.until(ExpectedConditions.visibilityOf(createAnewAccountLink))
                       .click();
    }
    ...
    public void enterUserName(String userName) {
        redrawTimeout.until(ExpectedConditions.elementToBeClickable(usernameInput))
                     .sendKeys(userName);
        redrawTimeout.until(ExpectedConditions.textToBePresentInElementValue(
