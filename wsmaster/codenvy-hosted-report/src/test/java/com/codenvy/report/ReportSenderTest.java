...
public class ReportSenderTest {
  ...
  public static final String REPORT_PARAMETERS_SERVICE =
      UPDATE_SERVER_ENDPOINT
          + "/report/parameters/"
          + ReportType.CODENVY_ONPREM_USER_NUMBER_REPORT.name().toLowerCase();

  public static ReportParameters REPORT_PARAMETERS;

  private ReportSender spyReportSender;

  @Mock private MailSender mockMailSender;
  @Mock private HttpJsonRequestFactory mockHttpJsonRequestFactory;
  @Mock private HttpJsonRequest mockHttpJsonRequest;
  @Mock private HttpJsonResponse mockHttpJsonResponse;
  ...
  public void setup() throws Exception {
    ...
    doReturn(mockHttpJsonRequest)
        .when(mockHttpJsonRequestFactory)
        .fromUrl(REPORT_PARAMETERS_SERVICE);
    ...
    doReturn(REPORT_PARAMETERS)
        .when(mockHttpJsonResponse)
  ...
  @Test
  public void shouldSendWeeklyReportBecauseOfExpiredLicense()
  ...
  @Test
  public void shouldSendWeeklyReportBecauseOfLicenseException()
      throws IOException, JsonParseException, MessagingException, ApiException {
    spyReportSender.sendWeeklyReports();
