...
/**
 * Prints info about product license expiration action into the audit report.
 *
 * @author Dmytro Nochevnov
 * @author Igor Vinokur
 */
public class ProductLicenseExpirationInfoPrinter extends Printer {

    private SystemLicenseAction licenseAction;

    public ProductLicenseExpirationInfoPrinter(Path auditReport, SystemLicenseAction licenseAction) {
        super(auditReport);
