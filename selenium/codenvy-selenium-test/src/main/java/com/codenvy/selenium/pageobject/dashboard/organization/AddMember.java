...
public class AddMember {
    ...
    private interface Locators {
        String ADD_MEMBER_TITLE_XPATH    = "//div[contains(@class, 'che-popup')]//div[text() = 'Invite member to collaborate']";
        ...
        String MEMBER_RADIO_BUTTON_XPATH = "//md-radio-button//span[text()='Member' or text()='Team Developer']/ancestor::md-radio-button";
        String ADMIN_RADIO_BUTTON_XPATH  = "//md-radio-button//span[text()='Admin' or text()='Team Admin']/ancestor::md-radio-button";
        ...
        String EDIT_PERMISSIONS_BUTTON   = "//span[text() = '%s']/ancestor::div[2]//div//a[@uib-tooltip =  'Edit developer permissions']";
    }
    ...
    public void closeWidget() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(closeWidget)).click();
    }

    public boolean checkAddButtonIsEnabled() {
        return redrawUiElementsTimeout.until(ExpectedConditions.visibilityOf(addMemberButton)).isEnabled();
    }
    ...
    public void clickEditPermissionsButton(String email) {
        redrawUiElementsTimeout
                .until(ExpectedConditions.visibilityOfElementLocated(By.xpath(String.format(Locators.EDIT_PERMISSIONS_BUTTON, email))))
                .click();
    }
     ...
     *
     * @param xpath
     *         xpath to match the 'che-popup' element
     */
