...
/**
 * Used by LoginFilter to check if request should be skipped. For complex case then configured
 * LoginFilter request should be skipped.
 *
...
public interface RequestFilter {
  /**
   * @param request - request in LoginFilter
