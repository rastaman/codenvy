...
public class MachineAuthGinModule extends AbstractGinModule {
  ...
  protected void configure() {
    bind(AsyncRequestFactory.class)
        .to(com.codenvy.machine.authentication.ide.MachineAsyncRequestFactory.class);
    bind(MachineTokenServiceClient.class)
        .to(com.codenvy.machine.authentication.ide.MachineTokenServiceClientImpl.class)
        .in(Singleton.class);
    bind(CheWsAgentLinksModifier.class)
        .to(com.codenvy.machine.authentication.ide.CodenvyMachineLinksModifier.class);
  }
}
