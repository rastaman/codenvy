...
public class WorkspaceFilesCleanUpScriptExecutorTest {
  ...
  public void cleanUp() throws Exception {
    workspaceFilesCleaner =
        spy(
            new WorkspaceFilesCleanUpScriptExecutor(
                workspaceIdHashLocationFinder, file, TEXT, CLEAN_UP_DURATION));
  ...
  public void shouldThrowServerExceptionInCaseWorkspaceFileCleanerThrowTimeOutException()
      throws Exception {
    doThrow(TimeoutException.class)
        .when(workspaceFilesCleaner)
        .execute(new String[] {TEXT, TEXT}, CLEAN_UP_DURATION);

    workspaceFilesCleaner.clear(workspace);
  }

  @Test(expectedExceptions = ServerException.class)
  public void shouldThrowServerExceptionInCaseWorkspaceFileCleanerThrowInterruptedException()
      throws Exception {
