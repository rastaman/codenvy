...
/**
 * Centralized authentication service that provide additional functionality. Additional
 * functionality is re-login after session destroying, anonymous login, invalidating some client in
 * ticket manager and retrieving user principal with roles from clients.
 *
