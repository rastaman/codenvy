...
public class AwsInitialAuthConfigTest {
  ...
  private final String AWS_ECR_HOSTNAME_1 =
      AWS_ID_VALUE_1 + ".dkr.ecr." + AWS_REGION_VALUE_1 + ".amazonaws.com";
  private final String AWS_ECR_HOSTNAME_2 =
      AWS_ID_VALUE_2 + ".dkr.ecr." + AWS_REGION_VALUE_2 + ".amazonaws.com";
  ...
  public void shouldParseAwsEcrConfigs() {
    ...
    addAwsAccountConfig(
        ...
        AWS_ID_VALUE_1,
        AWS_REGION_VALUE_1,
        AWS_ACCESS_KEY_ID_VALUE_1,
        AWS_SECRET_ACCESS_KEY_VALUE_1);
    addAwsAccountConfig(
        AWS_REGISTRY_NAME_2,
        AWS_ID_VALUE_2,
        AWS_REGION_VALUE_2,
        AWS_ACCESS_KEY_ID_VALUE_2,
        AWS_SECRET_ACCESS_KEY_VALUE_2);
  ...
  public void shouldThrowIllegalArgumentExceptionIfCredentialsNotFullyConfigured(
      String awsId, String awsRegion, String accessKeyId, String secretAccessKey) {
  ...
  public void shouldThrowIllegalArgumentExceptionIfSomeValuesInPropertiesNotConfigured(
  ...
  private void addAwsAccountConfig(
      String name, String id, String region, String keyId, String keyValue) {
