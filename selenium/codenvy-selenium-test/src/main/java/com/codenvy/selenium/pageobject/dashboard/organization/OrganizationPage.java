...
public class OrganizationPage {
    ...
    private interface Locators {
        ...
        String ORGANIZATION_TITLE_XPATH = "//div[contains(@class, 'che-toolbar-title')]//span[text() = '%s']";
        ...
        String DELETE_ORG_WIDGET_BUTTON = "//div[contains(@class,'che-confirm-dialog-notification')]//span";
        String SUB_ORGANIZATIONS_TAB       = "//md-tab-item//span[contains(text(), 'Sub-Organizations')]";

        String ADD_SUB_ORGANIZATION_BUTTON = "//che-button-primary[@che-button-title =  'Add Sub-Organization']/a";
        ...
        String MEMBERS_LIST_ITEM_XPATH     = "//md-content[contains(@class, 'organization-member-list')]//span[text() = '%s']";
    ...
    public void waitOrganizationTitle(String name) {
        new WebDriverWait(seleniumWebDriver, LOADER_TIMEOUT_SEC).until(ExpectedConditions.textToBe(By.id(Locators.ORGANIZATION_TITLE_ID), name));
    }
    ...
    public boolean isAddMemberButtonVisible() {
        List<WebElement> elements = seleniumWebDriver.findElements(By.xpath(Locators.ADD_MEMBER_BUTTON));
    ...
    public void waitOrganizationName(String name) {
        redrawUiElementsTimeout.until(ExpectedConditions.visibilityOf(organizationName)).getText().equals(name);
    }
    ...
    public int getWorkspaceCap() {
        return Integer.parseInt(redrawUiElementsTimeout.until(ExpectedConditions.visibilityOf(workspaceCap)).getText());
    }

    public int getRunningWorkspaceCap() {
        return Integer.parseInt(redrawUiElementsTimeout.until(ExpectedConditions.visibilityOf(runningWorkspaceCap)).getText());
    }

    public int getWorkspaceRamCap() {
        return Integer.parseInt(redrawUiElementsTimeout.until(ExpectedConditions.visibilityOf(workspaceRamCap)).getText());
    }
    ...
    public void setWorkspaceCap(int capSize) {
        ...
        redrawUiElementsTimeout.until(ExpectedConditions.visibilityOf(workspaceCap)).getText().equals(size);
    }
    ...
    public void setRunningWorkspaceCap(int capSize) {
        ...
        redrawUiElementsTimeout.until(ExpectedConditions.visibilityOf(runningWorkspaceCap)).sendKeys(String.valueOf(size));
        redrawUiElementsTimeout.until(ExpectedConditions.visibilityOf(runningWorkspaceCap)).getText().equals(size);
    }
    ...
    public void setWorkspaceRamCap(int capSize) {
        ...
        redrawUiElementsTimeout.until(ExpectedConditions.visibilityOf(workspaceRamCap)).sendKeys(String.valueOf(size));
        redrawUiElementsTimeout.until(ExpectedConditions.visibilityOf(workspaceRamCap)).getText().equals(size);
    }
    ...
    public void checkMemberExistsInMembersList(String email) {
        redrawUiElementsTimeout
                .until(ExpectedConditions.presenceOfElementLocated(By.xpath(String.format(Locators.MEMBERS_LIST_ITEM_XPATH, email))));
    }

    public void checkMemberIsNotExistsInMembersList(String email) {
        redrawUiElementsTimeout
                .until(ExpectedConditions.invisibilityOfElementLocated(By.xpath(String.format(Locators.MEMBERS_LIST_ITEM_XPATH, email))));
    }
    ...
    public boolean isDeleteButtonVisible() {
        List<WebElement> elements = seleniumWebDriver.findElements(By.xpath(Locators.DELETE_ORG_BUTTON));
        return elements.isEmpty() ? false : elements.get(0).isDisplayed();
    }
