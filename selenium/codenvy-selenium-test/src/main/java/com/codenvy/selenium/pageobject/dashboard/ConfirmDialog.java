...
public class ConfirmDialog {
    ...
    private interface Locators {
        ...
        String DIALOG_MESSAGE_XPATH      = "//che-popup//div[contains(@class, 'che-confirm-dialog-notification')]/div";
    ...
    public void closeDialog() {
        webDriverWait.until(visibilityOf(closeButton))
                     .click();
    ...
    public String getTitle() {
        return webDriverWait.until(visibilityOf(title))
                            .getText();
    }
    ...
    public String getMessage() {
        return webDriverWait.until(visibilityOf(message))
                            .getText();
    }
    ...
    public String getConfirmButtonTitle() {
        return webDriverWait.until(visibilityOf(confirmButton))
                            .getText();
    }
    ...
    public String getCancelButtonTitle() {
        return webDriverWait.until(visibilityOf(cancelButton))
                            .getText();
    }
    ...
    public void clickCancel() {
        webDriverWait.until(visibilityOf(cancelButton))
                     .click();
    }
    ...
    public void clickConfirm() {
        webDriverWait.until(visibilityOf(confirmButton))
                     .click();
    }
}
