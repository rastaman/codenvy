...
public class MachineSsoServerClientTest {
  ...
  public void initClient() throws Exception {
    ...
    ssoClient =
        new MachineSsoServerClient(ENDPOINT, requestFactoryMock, registrySpy, userManagerMock);
  }

  @Test
  public void getUserMustDelegateCallToTheSuperWhenTokenIsNotPrefixedWithMachine()
  ...
  @Test
  public void getUserMustReturnNullWhenTokenIsMachinePrefixedButUserForSuchTokenDoesNotExist()
      throws NotFoundException {
  ...
  @Test
  public void getSubjectMustReturnTheSubjectRetrievedFromTheApiRequestWithMachineToken()
      throws Exception {
    // machine token
