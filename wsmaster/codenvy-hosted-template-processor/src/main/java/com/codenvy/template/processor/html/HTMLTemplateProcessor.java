...
public interface HTMLTemplateProcessor<T> {
   ...
   *
   * @param template HTML template which resolving is provided by implementation
   * @param variables variables mapping in given HTML template
   * @return full filled HTML template as string
   * @throws TemplateNotFoundException when given {@code template} not found
   * @throws FailedProcessingTemplateException when any problems occurs during template processing
   */
   ...
   * @param template HTML template which resolving is provided by implementation
   * @param variables variables mapping in given HTML template
   * @param writer where the processed HTML template will be written to
   * @throws TemplateNotFoundException when given {@code template} not found
   * @throws FailedProcessingTemplateException when any problems occurs during template processing
   */
  void process(String template, Map<String, Object> variables, Writer writer)
      throws TemplateNotFoundException, FailedProcessingTemplateException;

  /**
   * Fills HTML representation of given template.
   *
   * @param template template instance to process
   * @return full filled HTML template as string
   */
