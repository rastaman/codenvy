...
public class RedirectToEngineerChatChannelAction extends Action {
  ...
  @Inject
  public RedirectToEngineerChatChannelAction(
      HelpLocalizationConstant locale, HelpResources resources) {
    super(
        locale.actionRedirectToEngineerChatChannelTitle(),
        locale.actionRedirectToEngineerChatChannelDescription(),
        null,
