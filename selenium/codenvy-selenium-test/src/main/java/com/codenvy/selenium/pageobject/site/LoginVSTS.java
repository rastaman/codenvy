...
public class LoginVSTS {
    ...
    public void waitLoginPage() {
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(loginPage));
    }
    ...
    public void waitSignInPage() {
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(signInPage));
    }
     ...
     *
     * @param login
     *         login for microsoft account
     */
    public void enterLogin(String login) {
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(loginInput)).sendKeys(login);
    }
    ...
    public void enterPassword(String password) {
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(passwordInput))
                                                                                 .sendKeys(password);
    }
    ...
    public void clickOnSignInBtn() {
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(signInBtn)).click();
    ...
    public void clickOnAcceptBtn() {
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(acceptBtn)).click();
    }
    ...
    public void clickOnContinueBtn() {
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(continueBtn)).click();
    ...
    public void waitLoginField(int timeoutDefinedByUser) {
        new WebDriverWait(seleniumWebDriver, timeoutDefinedByUser).until(ExpectedConditions.visibilityOf(passwordInput));
    }
