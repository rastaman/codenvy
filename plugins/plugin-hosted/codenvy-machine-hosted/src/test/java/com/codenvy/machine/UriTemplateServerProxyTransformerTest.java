...
public class UriTemplateServerProxyTransformerTest {
    ...
    ServerImpl originServer =
        new ServerImpl(
            ...
            new ServerPropertiesImpl(
                "some/path", "my-server.com:32589", "http://my-server.com:32589/some/path"));
    ServerImpl expectedServer =
        new ServerImpl(
            originServer.getRef(),
            "http",
  ...
  public void shouldNotAdd80PortToUrl() throws Exception {
    serverModifier =
        new UriTemplateServerProxyTransformer("http://transform-host/%4$s", null, null) {};
    ServerImpl originServer =
        new ServerImpl(
            "myRef",
            "http",
  ...
  public void shouldBeAbleToChangeServerAttributes() throws Exception {
    serverModifier =
        new UriTemplateServerProxyTransformer(
            "https://%3$s-%2$s.transform-host:444/%1$s/%4$s", null, null) {};
    ServerImpl originServer =
        new ServerImpl(
            "myRef",
            "http",
  ...
  public void shouldBeAbleToChangeServerAttributesWithCustomAttributes() throws Exception {
    serverModifier =
        new UriTemplateServerProxyTransformer(
            "https://%5$s/%3$s_%2$s/%4$s", "public-host.com", "localhost") {};
    ServerImpl originServer =
        new ServerImpl(
            "myRef",
            "http",
  ...
  public void shouldWorkProperlyIfPathIsNull() throws Exception {
    serverModifier =
        new UriTemplateServerProxyTransformer(
            "https://%3$s-%2$s.transform-host:444/%4$s", null, null) {};
    ServerImpl originServer =
        new ServerImpl(
            "myRef",
            "http",
            ...
            new ServerPropertiesImpl(null, "my-server.com:32589", "http://my-server.com:32589/"));
    ServerImpl expectedServer =
        new ServerImpl(
            "myRef",
            "https",
